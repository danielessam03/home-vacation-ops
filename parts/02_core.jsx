    ...
    const SUPABASE_URL = 'YOUR_SUPABASE_URL';            // https://xxxx.supabase.co  (NEW HV Ops project)
    const SUPABASE_ANON_KEY = 'YOUR_SUPABASE_ANON_KEY';  // anon / publishable key — safe here, RLS protects the data
