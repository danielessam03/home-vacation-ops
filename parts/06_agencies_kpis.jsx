    ...
    const kpiDefsForUser = (cfg, role, k) => {
      const active = { entry: k.listings_entered > 0 || k.projects_entered > 0 || k.shoots_approved > 0, upload: k.listings_uploaded > 0 || k.waiting_upload > 0 || k.projects_uploaded > 0 };
